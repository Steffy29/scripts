...
curl -X POST -H "X-Vault-Token:$vault_token" -H 'Content-type: application/json' -d '{"jwttoken":"hjhgfjkghfkhfgkdf-434545656546211-jfdkgfdgkdf-4325464562ggtrger-34435546563"}' http://127.0.0.1:8200/v1/secret/bsensory/keys/secure/jwttoken
